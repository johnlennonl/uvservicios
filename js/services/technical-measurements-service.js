...
export async function getWellRibbonData(pozoName) {
    ...
    return {
        ...
        vsd_kva: firstUsableBESValue(besProfile?.vsd_kva),
        marca_vsd: firstUsableBESValue(besProfile?.marca_vsd),
        modelo_vsd: firstUsableBESValue(besProfile?.modelo_vsd),
        tx_kva: firstUsableBESValue(besProfile?.tx_kva),
        tap_v: firstUsableBESValue(besProfile?.tap_v),
        rt: firstUsableBESValue(besProfile?.rt),
